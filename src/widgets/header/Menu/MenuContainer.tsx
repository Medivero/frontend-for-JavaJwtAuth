...
function MenuContainer(){
    ...
    return (
        <>
        <div>
            <div style={{transform: `translateX(${stateOfMenu ? "0" : "-100"}%)`}} className={`fixed duration-700 top-0 z-1 transition-all bg-gray-800 w-[400px] h-screen`}>
                <div className="flex flex-col mt-[100px] px-[40px] text-[26px]">
                    <a href="/">FILMFINDER</a>
                    <a href={`/profile/`}><span>PROFILE</span></a>
                </div>
            </div>
            <div className="absolute left-0 top-0 ml-[50px] mt-[20px] z-10">
